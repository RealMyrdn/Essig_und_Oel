...
//    }
    static function regNewUser() {
        $i=0;
        $fields[]='Vorname, vorname, text, Nachname, nachname, text, Strasse, strasse, text, PLZ, plz, text, Email, email, email, Passwort, password, password, Passwort wiederholen, repassword, password';
